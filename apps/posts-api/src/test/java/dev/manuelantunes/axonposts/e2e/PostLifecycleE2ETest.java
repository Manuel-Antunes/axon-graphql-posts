...
class PostLifecycleE2ETest extends AbstractGraphQlE2ETest {
    ...
    void aNewPostArrivesAlreadyTaggedAtVersionTwo() {
        ...
        // 1 = PRÉ-criado, 2 = completo (primeira tag). A mutation espera o after-commit completar.
        // Em prod quem decide a tag é OUTRO SERVIÇO e esta resposta é versão 1: o post fica completo
        // quando a decisão volta pelo broker. Ver `axonposts.saga.tagging-in-process` e docker/e2e/.
