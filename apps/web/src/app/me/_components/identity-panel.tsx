    ...
    if (!session) {
        return (
            <Alert>
                ...
                <AlertDescription>
                    A autenticação não é proativa nesta API: <span className="font-mono">posts</span>{" "}
                    é pública no mesmo POST em que <span className="font-mono">me</span> exige bearer.{" "}
...
function IdentityCard({ user }: { user: FragmentType<typeof IdentityPanel_user> }) {
        ...
        <div className="space-y-5">
            <Card>
                <CardHeader>
                    <div className="flex items-center gap-2">
                        ...
                        <Badge variant={isAuthor ? "default" : "secondary"} className="font-mono text-[10px]">
                            {me.__typename}
                        </Badge>
                    </div>
                    <CardDescription>
                ...
                <CardContent className="space-y-4">
                    ...
                    <div>
                        ...
                        <Table>
                            ...
                            <TableBody>
                                {me.accounts.filter((account) => account !== null).map((account) => (
            ...
            {isAuthor ? (
                <section className="space-y-3">
                    ...
                    />
                    <Link href="/posts/new" className={cn(buttonVariants({ variant: "outline", size: "sm" }))}>
                        Escrever um post
                    </Link>
                </section>
            ) : null}
