...
import { COGNITO_ISSUER, GRAPHQL_UPSTREAM } from "@/lib/env";
...
const flows = [
    ...
    },
    {
        ...
        proves: "Paginação Relay e fragmentos por componente: o card não pede `content`.",
    },
    {
        href: "/posts/new",
        icon: PenLineIcon,
        ...
        proves: "O post nasce na versão 1, SEM tag. Quem completa é o outro serviço.",
    },
    {
        href: "/saga",
        icon: WorkflowIcon,
    ...
    },
    {
        ...
        proves: "O transporte é GraphQL over SSE. Contra o Lambda ele NÃO entrega — e a página diz por quê.",
    },
    {
        href: "/me",
        icon: UserIcon,
        ...
        proves: "possibleTypes no cache, e o account linking entre Keycloak e Cognito.",
    },
    {
        href: "/federation",
        icon: NetworkIcon,
        ...
        <div className="space-y-8">
            <section className="space-y-3">
                ...
                <p className="max-w-2xl text-muted-foreground">
                    Este cliente não existe para ser bonito: cada página exercita uma decisão de
                    arquitetura do <span className="font-mono text-foreground">axonposts</span> e
                    mostra o resultado como ele é — inclusive quando o resultado é que alguma coisa
                    não atravessa.
                </p>
                <dl className="grid gap-2 pt-2 text-xs text-muted-foreground sm:grid-cols-2">
                    ...
                    <div>
                        <dt className="font-medium text-foreground">Emissor</dt>
                        <dd className="font-mono break-all">{COGNITO_ISSUER || "não configurado"}</dd>
                    </div>
                </dl>
            </section>
                        ...
                        <Card className="h-full transition-colors group-hover:border-foreground/25">
                            <CardHeader>
                                <div className="flex items-center gap-2">
                                    <flow.icon className="size-4 text-muted-foreground" aria-hidden />
