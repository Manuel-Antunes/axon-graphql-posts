...
import { useSagaRun, type SagaEvent } from "../_hooks/use-saga-run";
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="flex items-center gap-2 text-base">
                        ...
                        A travessia entre os dois serviços
                    </CardTitle>
                    <CardDescription>
                        ...
                        . Nenhum dos dois serviços nomeia o outro: um publica, o outro escuta.
                    </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                    ...
                    {status === "closed" ? (
                        <p className="text-sm text-emerald-600 dark:text-emerald-400">
                            Saga fechada. O tempo acima inclui o cold start das funções — rode de novo
                            com elas quentes para separar as duas coisas.
                        </p>
                    ) : null}
                </CardContent>
            </Card>
