 ...
 * solta num serviço. A implementação é o {@code BcryptUtil} do Quarkus, ligado por um lambda no
 * {@code SecurityProducer} — trocar BCrypt por Argon2 não toca em nada aqui.
 */
@FunctionalInterface
